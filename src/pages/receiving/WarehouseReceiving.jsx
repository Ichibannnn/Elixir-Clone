...
const WarehouseReceiving = () => {
  ...
  return (
    <Flex color="fontColor" h="auto" w="full" borderRadius="md" flexDirection="column" bg="background">
      <Flex bg="btnColor" borderRadius="10px 10px 0px 0px" w="19%" pl={2}>
        <Text p={2} fontWeight="semibold"  fontSize="12px" color="white">Purchase Order Summary List</Text>
      </Flex>
        ...
        <PageScroll>
              {isLoading ? (
                ...
                <Table
                  ...
                  variant="striped"
                >
                  <Thead bg="primary" position="sticky" top={0} bgColor="secondary">
                    <Tr>
                          ...
                          <Flex>
                              ...
                              <Menu>
                                  ...
                                  {/* <MenuDivider/> */}
                                    ...
                                    <MenuItem icon={<GiCancel fontSize="17px"/>} onClick={() => cancelModalHandler(pos.id)}>
              ...
              !viewData ? (
                ...
                <Tbody>
                  <Tr key={viewData.id}>
                    ...
                    <Td fontSize="11px">{moment(viewData.poDate).format("MM/DD/YYYY")}</Td>
                    <Td fontSize="11px">{viewData.prNumber}</Td>
                    <Td fontSize="11px">{moment(viewData.prDate).format("MM/DD/YYYY")}</Td>
