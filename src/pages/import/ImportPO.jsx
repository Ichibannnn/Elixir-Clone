import { Box, Button, Flex, HStack, Input, Table, Tbody, Td, Text, Th, Thead, Tr, VStack, AlertDialog,
  AlertDialogBody,
  AlertDialogFooter,
  AlertDialogHeader,
  AlertDialogContent,
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        if (resultArray.length > 0) {
          ...
          try {
            setIsLoading(true)
            const res = request.post('Import/AddNewPOSummary', resultArray).then((res) => {
          ...
          <Table variant="striped" size='sm'>
            ...
            <Tbody>
              {resultArray?.map((eData, i) => 
               <Tr key={i}>
                  <Td fontSize="11px">{eData.pR_Number ? eData.pR_Number : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.pR_Date ? eData.pR_Date : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO Date is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.pO_Number ? eData.pO_Number : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.pO_Date ? eData.pO_Date : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.itemCode ? eData.itemCode : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.itemDescription ? eData.itemDescription : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.ordered ? eData.ordered : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.delivered < 0 ? <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text> : eData.delivered}</Td>
                  <Td fontSize="11px">{eData.billed < 0 ? <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text> : eData.uom}</Td>
                  <Td fontSize="11px">{eData.uom ? eData.uom : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.unitPrice ? eData.unitPrice : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
                  <Td fontSize="11px">{eData.vendorName ? eData.vendorName : <Text fontWeight='semibold' color='danger'>Data missing. Please make sure correct excel file for PO is uploaded.</Text>}</Td>
               </Tr> 
              )}
            </Tbody>
          </Table>
